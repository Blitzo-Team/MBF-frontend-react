    ...
    {/* Plan meal */}
      <SubMenu
          ...
          title={
            ...
            {/* Breakfast */}
              ...
              <SubMenu
                  ...
                  title={
                    <span>
                      <Icon style={{marginTop: '10px', fontSize: '20px', float: 'left'}} type="clock-circle" />
                      <span>Breakfast</span>
                    </span>}>
              ...
              <SubMenu
                ...
                title={
                  <span>
                    <Icon style={{marginTop: '10px', fontSize: '20px', float: 'left'}} type="experiment" />
                    <span>Snacks</span>
                  </span>}>
              ...
              <SubMenu
                ...
                title={
                  <span>
                    <Icon style={{marginTop: '10px', fontSize: '20px', float: 'left'}} type="bell" />
                    <span>Lunch</span>
                  </span>}>
            ...
            <SubMenu
                ...
                title={
                  <span>
                    <Icon style={{marginTop: '10px', fontSize: '20px', float: 'left'}} type="book" />
                    <span>Dinner</span>
                  </span>}>
        ...
        <Layout  
          ...
          <Parallax strength={200} >
            ...
            <Menu
              ...
              <Menu.Item style={{ float: "right" }}>
                <a style={{ color: "black", border: '1px solid transparent' }}>
                  <Icon style={{marginTop: '20px', float: "right", fontSize: '20px'}} type="shopping-cart" />
                </a>
              </Menu.Item>
          ...
          <div className= { this.state.hover === false ? "container header-menu" : "container header-menu-not"} >
            <Row>
              <Col span={10}>
                <ul
                  style={{
